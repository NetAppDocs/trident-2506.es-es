...
| `luksEncryption` | Habilita el cifrado LUKS. Consulta link:../trident-reco/security-luks.html["Utilice la configuración de clave unificada de Linux (LUKS)."]. Solo SAN. | "" 
