...
Generalmente, deberías actualizar usando el mismo método que usaste para la instalación inicial, aunque puedes link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["cambiar entre métodos de instalación"]. Hay dos opciones para actualizar Trident.
