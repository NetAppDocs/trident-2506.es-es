...
Para obtener información sobre FlexGroups y las cargas de trabajo que son adecuadas para FlexGroups, consulta la  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Guía de implementación y mejores prácticas de NetApp FlexGroup volume"^].
