...
Ahora puedes crear el `TridentOrchestrator` e instalar Trident. Opcionalmente, puedes link:../trident-install/kubernetes-customize-deploy.html["Personaliza tu instalación de Trident"] usando los atributos en la `TridentOrchestrator` spec.
