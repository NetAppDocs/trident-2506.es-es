...
summary: Puede utilizar el selector de versiones para navegar entre la última versión y las cuatro versiones anteriores o utilizar los enlaces que aparecen a continuación. 
---
...
[role="lead"]
Si no está utilizando Trident 25.06, la documentación de las versiones anteriores está disponible en función delink:get-help.html["ciclo de vida del soporte Trident"] .
