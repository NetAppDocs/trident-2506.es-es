...
---
= Proteja sus aplicaciones con Trident Protect.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Puedes proteger todas las aplicaciones gestionadas por Trident Protect tomando instantáneas y copias de seguridad utilizando una política de protección automatizada o de forma puntual.
...
Si ha instalado Trident Protect, puede habilitar la funcionalidad de copia de seguridad y restauración con uso eficiente del espacio para los backends de almacenamiento que utilizan la clase de almacenamiento azure-netapp-files y que se crearon antes de Trident 24.06.  Esta funcionalidad funciona con volúmenes NFSv4 y no consume espacio adicional del grupo de capacidad.

.Antes de empezar
Asegúrese de lo siguiente:

* Has instalado Trident Protect.
* Has definido una aplicación en Trident Protect.  Esta aplicación tendrá una funcionalidad de protección limitada hasta que complete este procedimiento.
...
.Resultado
La aplicación está lista para realizar copias de seguridad y restauración utilizando Trident Protect.  Cada PVC también está disponible para ser utilizado por otras aplicaciones para copias de seguridad y restauraciones.
