...
| protect.trident.netapp.io/data-mover-timeout-sec | cadena | Tiempo máximo (en segundos) permitido para que se detenga la operación de transferencia de datos. | "300" 
